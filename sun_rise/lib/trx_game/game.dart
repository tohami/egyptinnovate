...
import 'package:sun_rise/trx_game/Horizon/horizon.dart';
import 'package:sun_rise/trx_game/collision/collision_utils.dart';
import 'package:sun_rise/trx_game/game_config.dart';
import 'package:sun_rise/trx_game/game_over/game_over.dart';
import 'package:sun_rise/trx_game/no_internet/no_internet.dart';
import 'package:sun_rise/trx_game/t_rex/config.dart';
import 'package:sun_rise/trx_game/t_rex/t_rex.dart';
...
class TRexGame extends BaseGame {
  ...
  TRexGame({Image spriteImage}) {
    ...
    this..add(horizon)..add(tRex)..add(gameOverPanel)..add(NoInternetText());
  }
